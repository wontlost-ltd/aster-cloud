...
export const DEMO_SUPPLEMENT: Record<Locale, MessageTree> = {
  en: {
    ...
    policyReview: {
      ...
      rejected: 'Rejected',
      empty: 'Nothing needs review — every candidate was machine-verified.',
    ...
    whatIf: {
      ...
      valueImpact: 'Estimated value impact',
    ...
    settings: {
      totp: {
        ...
        statusEnabled: 'Authenticator app is enabled.',
        statusDisabled: 'Not set up. You currently receive sign-in codes by email.',
        remainingCodes: '{count} recovery codes remaining.',
        start: 'Set up authenticator',
        starting: 'Preparing…',
        scanHint: 'Scan this with your authenticator app, then enter the 6-digit code it shows.',
        manualKeyLabel: 'Or enter this key manually',
        confirmLabel: 'Code from your app',
        confirmHint: 'This confirms the app is set up correctly before we switch it on.',
        confirm: 'Enable',
        confirming: 'Enabling…',
        cancel: 'Cancel',
        recoveryTitle: 'Save your recovery codes',
        recoveryWarning: 'Write these down now — they are shown only once. Without them, losing your phone means losing access to your account.',
        recoveryDone: 'I have saved them',
        disable: 'Turn off authenticator',
        disabling: 'Turning off…',
        disableHint: 'Enter a code from your app (or a recovery code) to confirm',
        loadFailed: 'Could not load your authenticator settings.',
        confirmFailed: 'That code did not match. Check your app and try again.',
        disableFailed: 'That code did not match. Authenticator is still on.',
        alreadyEnabled: 'Authenticator is already enabled. Turn it off first to set up a new device.',
      },
      trustedDevices: {
  ...
  zh: {
    ...
    settings: {
      totp: {
        ...
        statusEnabled: '验证器 App 已启用。',
        statusDisabled: '尚未设置。当前通过邮件接收登录验证码。',
        remainingCodes: '剩余恢复码 {count} 个。',
        start: '设置验证器',
        starting: '准备中…',
        scanHint: '用验证器 App 扫描下方二维码，然后输入 App 显示的 6 位动态码。',
        manualKeyLabel: '或手动输入此密钥',
        confirmLabel: 'App 上的动态码',
        confirmHint: '先确认 App 已正确设置，我们才会真正启用——避免扫码失败后被锁在门外。',
        confirm: '启用',
        confirming: '启用中…',
        cancel: '取消',
        recoveryTitle: '请保存恢复码',
        recoveryWarning: '现在就抄下来——它们只显示这一次。没有恢复码时，手机丢失将导致无法登录账户。',
        recoveryDone: '我已保存',
        disable: '关闭验证器',
        disabling: '关闭中…',
        disableHint: '输入 App 上的动态码（或一个恢复码）以确认',
        loadFailed: '无法加载验证器设置。',
        confirmFailed: '动态码不匹配。请检查 App 后重试。',
        disableFailed: '动态码不匹配，验证器仍处于启用状态。',
        alreadyEnabled: '验证器已启用。要换设备请先关闭，再重新设置。',
      },
      trustedDevices: {
        title: '已信任的设备',
  ...
  de: {
    ...
    whatIf: {
      ...
      valueImpact: 'Geschätzte Wertauswirkung',
    ...
    settings: {
      totp: {
        ...
        statusEnabled: 'Authenticator-App ist aktiviert.',
        statusDisabled: 'Nicht eingerichtet. Sie erhalten Anmeldecodes derzeit per E-Mail.',
        remainingCodes: 'Noch {count} Wiederherstellungscodes vorhanden.',
        start: 'Authenticator einrichten',
        starting: 'Wird vorbereitet…',
        scanHint: 'Scannen Sie dies mit Ihrer Authenticator-App und geben Sie den angezeigten 6-stelligen Code ein.',
        manualKeyLabel: 'Oder diesen Schlüssel manuell eingeben',
        confirmLabel: 'Code aus Ihrer App',
        confirmHint: 'Damit bestätigen wir die korrekte Einrichtung, bevor wir sie aktivieren.',
        confirm: 'Aktivieren',
        confirming: 'Wird aktiviert…',
        cancel: 'Abbrechen',
        recoveryTitle: 'Wiederherstellungscodes speichern',
        recoveryWarning: 'Notieren Sie diese jetzt — sie werden nur einmal angezeigt. Ohne sie bedeutet der Verlust Ihres Telefons den Verlust des Kontozugangs.',
        recoveryDone: 'Ich habe sie gespeichert',
        disable: 'Authenticator deaktivieren',
        disabling: 'Wird deaktiviert…',
        disableHint: 'Geben Sie einen Code aus Ihrer App (oder einen Wiederherstellungscode) zur Bestätigung ein',
        loadFailed: 'Authenticator-Einstellungen konnten nicht geladen werden.',
        confirmFailed: 'Dieser Code stimmt nicht. Prüfen Sie Ihre App und versuchen Sie es erneut.',
        disableFailed: 'Dieser Code stimmt nicht. Authenticator bleibt aktiviert.',
        alreadyEnabled: 'Authenticator ist bereits aktiviert. Deaktivieren Sie ihn zuerst, um ein neues Gerät einzurichten.',
      },
      trustedDevices: {
  ...
  hi: {
    ...
    whatIf: {
      ...
      valueImpact: 'अनुमानित मूल्य प्रभाव',
    ...
    settings: {
      totp: {
        ...
        statusEnabled: 'प्रमाणक ऐप सक्षम है।',
        statusDisabled: 'सेट अप नहीं है। आपको अभी ईमेल से साइन-इन कोड मिलते हैं।',
        remainingCodes: '{count} पुनर्प्राप्ति कोड शेष हैं।',
        start: 'प्रमाणक सेट अप करें',
        starting: 'तैयार हो रहा है…',
        scanHint: 'इसे अपने प्रमाणक ऐप से स्कैन करें, फिर दिखाया गया 6-अंकीय कोड दर्ज करें।',
        manualKeyLabel: 'या यह कुंजी मैन्युअल रूप से दर्ज करें',
        confirmLabel: 'आपके ऐप का कोड',
        confirmHint: 'सक्षम करने से पहले यह पुष्टि करता है कि ऐप सही ढंग से सेट अप है।',
        confirm: 'सक्षम करें',
        confirming: 'सक्षम किया जा रहा है…',
        cancel: 'रद्द करें',
        recoveryTitle: 'अपने पुनर्प्राप्ति कोड सहेजें',
        recoveryWarning: 'इन्हें अभी लिख लें — ये केवल एक बार दिखाए जाते हैं। इनके बिना फ़ोन खोने का अर्थ है खाते तक पहुँच खोना।',
        recoveryDone: 'मैंने सहेज लिए',
        disable: 'प्रमाणक बंद करें',
        disabling: 'बंद किया जा रहा है…',
        disableHint: 'पुष्टि के लिए अपने ऐप का कोड (या पुनर्प्राप्ति कोड) दर्ज करें',
        loadFailed: 'प्रमाणक सेटिंग्स लोड नहीं हो सकीं।',
        confirmFailed: 'यह कोड मेल नहीं खाया। अपना ऐप जाँचें और पुनः प्रयास करें।',
        disableFailed: 'यह कोड मेल नहीं खाया। प्रमाणक अब भी चालू है।',
        alreadyEnabled: 'प्रमाणक पहले से सक्षम है। नया डिवाइस सेट करने के लिए पहले इसे बंद करें।',
      },
      trustedDevices: {
